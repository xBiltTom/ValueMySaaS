...
export default function AiKeysPage() {
  ...
  return (
    <DashboardShell>
      <div className="mb-6">
        <p className="text-sm font-semibold uppercase tracking-[0.18em] text-muted-foreground">Configuración</p>
        <h1 className="mt-1 font-display text-4xl font-semibold">API Keys de IA</h1>
        <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
          Configura tus propias claves para habilitar análisis avanzados sin trasladar costos de IA a la plataforma.
        </p>
      </div>
        ...
        <section className="space-y-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              El backend solo devuelve metadata segura. La clave completa no se muestra después de guardarla.
            </p>
          </div>
