    ...
    return (
      <Card className="p-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold">Sin diagnóstico aún</h2>
            <p className="text-sm text-muted-foreground">Registra métricas y genera un score explicable.</p>
          </div>
        </div>
      </Card>
    );
    ...
    <Card className="p-5">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
        ...
        <div className="min-w-0">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-muted-foreground">Score heurístico</p>
          <h2 className="mt-1 text-2xl font-semibold">{formatEnum(score.sustainability_level)}</h2>
          <p className="mt-2 text-sm text-muted-foreground">Recomendación: {formatEnum(score.decision_recommendation)}</p>
