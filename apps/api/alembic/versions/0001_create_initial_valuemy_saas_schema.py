...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("category", sa.Enum("EDTECH", "FINTECH", "HEALTHTECH", "PRODUCTIVITY", "MARKETING", "ECOMMERCE", "AI", "DEVELOPER_TOOLS", "OTHER", name="saascategory"), nullable=True),
        sa.Column("stage", sa.Enum("IDEA", "PLANNING", "MVP", "LAUNCHED", "GROWING", "PAUSED", name="saasstage"), nullable=False),
        sa.Column("business_model", sa.Enum("B2B", "B2C", "B2B2C", "FREEMIUM", "SUBSCRIPTION", "ONE_TIME", "OTHER", name="businessmodel"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("sustainability_level", sa.Enum("HEALTHY", "VIABLE_WITH_ADJUSTMENTS", "RISKY", "UNSUSTAINABLE", "INSUFFICIENT_DATA", name="sustainabilitylevel"), nullable=False),
        sa.Column("decision_recommendation", sa.Enum("CONTINUE", "IMPROVE", "PIVOT", "PAUSE", "DISCARD", "INSUFFICIENT_DATA", name="decisionrecommendation"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("provider", sa.Enum("OPENAI", "GEMINI", "ANTHROPIC", "OPENROUTER", "OTHER", name="aiprovider"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("analysis_type", sa.Enum("EXECUTIVE_SUMMARY", "RISK_ANALYSIS", "PRICING_ANALYSIS", "GROWTH_ANALYSIS", "RETENTION_ANALYSIS", "FULL_DIAGNOSIS", "CUSTOM", name="aianalysistype"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("provider", sa.Enum("OPENAI", "GEMINI", "ANTHROPIC", "OPENROUTER", "OTHER", name="aiprovider"), nullable=True),
        sa.Column("model_name", sa.String(100), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Enum("SYSTEM", "USER", "ASSISTANT", "TOOL", name="chatrole"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("report_type", sa.Enum("BASIC", "EXECUTIVE", "AI_ASSISTED", "SCENARIO_SIMULATION", name="reporttype"), nullable=False),
        sa.Column("status", sa.Enum("DRAFT", "GENERATED", "FAILED", name="reportstatus"), nullable=False),
